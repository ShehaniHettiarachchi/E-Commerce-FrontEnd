...
const Home = () => {
    ...
    return (
        ...
        <div>
            ...
            <MetaData title="Orange Electronics Products" />
            <div className="banner">
                <p> Welcome to Orange Electronics  </p>
                
                <h1> FIND AMAZING PRODUCTS BELOW </h1>
                
                <center><button onClick={() => { loadData('/orders') }} className='spclBtn'> Admin </button></center>
