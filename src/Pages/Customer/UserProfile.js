...
export default function UserProfile() {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://Localhost:8070/customer/get/${id}`, customer)
            .then((res) => [
                    ...
                    <MDBCol lg="5">
                        <MDBCard className="mb-4 fluid">
                            <MDBCardBody className="text-center">
                                <MDBCardImage
                                    src="https://i.dlpng.com/static/png/6334043_preview.png"
                                    alt="avatar"
                                ...
                                <button
                                    ...
                                    className=" btn btn-info  btn-sm text-center fw-bold text-white pt-0 mb-4 mb-4 mx-5 w-50"
                                    
                                >
                                    <Link to = {`/customer-update-profile/${localStorage.getItem("uID")}`}>
                                    Update Account
                                    </Link>
                                </button>
                            </MDBCardBody>
                        ...
                        <MDBCard className="mb-4">
                            <MDBCardBody>
                                <MDBRow>
                                    ...
                                    <MDBCol>
                                        <p><b>Contact No: {phone_number}</b></p>
                                    </MDBCol>
                                </MDBRow>
                            </MDBCardBody>
                        </MDBCard>
