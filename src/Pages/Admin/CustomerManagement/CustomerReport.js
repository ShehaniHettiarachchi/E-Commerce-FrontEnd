...
export default function CustomerReport () {
    ...
    useEffect(() => {
      ...
      const UserName = allCustomer.filter((elem)=> elem.User == "Users").reduce((acc,elem)=> acc + 1, 0);

      const UserRole = allCustomer.filter((elem)=> elem.User == "Role").reduce((acc,elem)=> acc + 1, 0);
